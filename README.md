...
- **EMS (Express Mail Service)**
  ...
  - 우체국에서 제공하는 국제 특송 서비스로, 전 세계 190개국 이상으로 빠르고 안정적인 배송을 제공합니다.

- **UPS (United Parcel Service)**

  - 세계 최대의 물류 회사 중 하나로, 국제 배송, 화물 운송 및 공급망 솔루션을 전문으로 제공합니다.

- **DHL (DHL Express)**

  - 글로벌 특송 서비스의 선두주자로, 신속한 국제 배송과 다양한 맞춤형 물류 솔루션을 제공합니다.
...
<img src="./public/tech.png" alt="기술 스택">
